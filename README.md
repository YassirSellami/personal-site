...
[![Build Status](https://img.shields.io/github/actions/workflow/status/YassirSellami/personal-site/node.js.yml?branch=main)](https://github.com/YassirSellami/personal-site/actions)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](./LICENSE)
[![GitHub Stars](https://img.shields.io/github/stars/YassirSellami/personal-site?style=social)](https://github.com/YassirSellami/personal-site/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/YassirSellami/personal-site?style=social)](https://github.com/YassirSellami/personal-site/network/members)
...
**[See it live →](https://ysellami.com)**
...
```bash
gh repo fork YassirSellami/personal-site --clone
cd personal-site
npm install
npm run dev
```
